...
%INSTALL_DIR%\setup-x86_64.exe -q -n -W -s http://cygwin.mirror.constant.com/ --root %~dp0\vendor\cygwin -l %INSTALL_DIR%\tmp -P gcc-core -P gcc-g++ -P make -p gdb -P binutils
